<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty.master" AutoEventWireup="true" CodeFile="Fdisp_grade.aspx.cs" Inherits="faculty_page_Fdisp_grade" %>
               ...
               <div class="panel panel-primary" style="border:1px solid ;background-color:aliceblue">
                   ...
                   <div class="panel-body">
                        <asp:Panel ID="Panel1" runat="server" Width="50%" >
                           ...
                           <div class="col-sm-10 col-md-10" style="padding:8px;font-weight:600">Batch<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox></div>                 
