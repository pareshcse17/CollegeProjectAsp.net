<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="disp_teaches.aspx.cs" Inherits="_Default" %>
               ...
               <div class="panel panel-primary" style="border:1px solid ;background-color:aliceblue">
                   ...
                   <div class="panel-body">
                       <asp:Panel ID="Panel2" runat="server" Width="40%" >
                           ...
                           <div class="col-sm-10 col-md-10" style="padding:8px;font-weight:600">Subject ID<asp:TextBox ID="TextBox2" runat="server" CssClass="form-control"></asp:TextBox></div>                 
                             <div class="col-sm-10 col-md-10" style="padding:10px;font-weight:600;text-align:center">
                       ...
                       <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" OnRowEditing="GridView1_RowEditing" CellPadding="4" ForeColor="#333333" GridLines="None">
                           ...
                           <Columns>
                               ...
                               <asp:TemplateField>
                                   ...
                                   <EditItemTemplate>
                                       <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-primary" CommandArgument='<%#Eval("t_pk") %>' OnCommand="LinkButton2_Command">Update</asp:LinkButton>
                                       <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-primary" OnClick="LinkButton3_Click">Cancel</asp:LinkButton>
                                   </EditItemTemplate>
                               </asp:TemplateField>
                               <asp:TemplateField>
                                   <ItemTemplate>
                                       <asp:LinkButton ID="LinkButton4" runat="server" CommandArgument='<%#Eval("t_pk") %>' CssClass="btn btn-danger" OnCommand="LinkButton4_Command">Delete</asp:LinkButton>
                                   </ItemTemplate>
                               </asp:TemplateField>
                           </Columns>
