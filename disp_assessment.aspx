<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="disp_assessment.aspx.cs" Inherits="disp_assessment" %>
               ...
               <div class="panel panel-primary" style="border:1px solid ;background-color:aliceblue">
                   ...
                   <div class="panel-body">
                       <asp:Panel ID="Panel1" runat="server" Width="40%" >
                           ...
                           <div class="col-sm-10 col-md-10" style="padding:8px;font-weight:600">Stu-Sub ID<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox></div>                 
