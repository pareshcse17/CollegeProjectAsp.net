<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_WebsiteLayout.aspx.cs" Inherits="_WebsiteLayout" %>
<!doctype html>
<html lang="en">
...
<body>
    <header class="header_area">
        <div class="header-top" style="max-width:100%; background-color:#e94086 ; height:40px; padding-top:10px;">
		</div>
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" style="margin-right:-200px;" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item"><a style="font-size:22px;" class="nav-link pull-left" href="Login.aspx">Log In</a></li>
							<li class="nav-item active"><a  style="font-size:22px;" class="nav-link pull-left" href="#">Home</a></li>
							<li class="nav-item"><a style="font-size:22px;" class="nav-link pull-left" href="about-us.html">About</a></li>
							<li class="nav-item submenu dropdown pull-left">
								<a href="#" style="font-size:22px;" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false">Pages</a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a style="font-size:22px;" class="nav-link" href="courses.html">Courses</a></li>
									<li class="nav-item"><a style="font-size:22px;" class="nav-link" href="course-details.html">Course Details</a></li>
									<li class="nav-item"><a class="nav-link" style="font-size:22px;" href="elements.html">Elements</a></li>
								</ul>
							</li>
							<li class="nav-item"><a style="font-size:22px;" class="nav-link pull-left" href="contact.html">Contact</a></li>

							<li class="nav-item">
								<a style="font-size:22px;" href="#" class="nav-link search" id="search">
					...
					<div class="col-lg-6">
						<div class="banner_content">
							...
							<div class="search_course_wrap">
								<form class="form_box d-flex justify-content-between w-100">
