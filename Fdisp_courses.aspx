<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty.master" AutoEventWireup="true" CodeFile="Fdisp_courses.aspx.cs" Inherits="faculty_page_Fdisp_courses" %>
     ...
     <div class="row" style="">
           <div class ="col-md-10 col-sm-10" style="padding-top:60px;padding-left:100px;padding-bottom:60px">
               <div class="panel panel-primary" style="border:1px solid ;background-color:aliceblue">
                   <div class="panel-heading" style="font-size:25px; height:50px;background-color:cadetblue;font-weight:bold">Courses Display Panel</div>
                   ...
                   <div class="panel-body">
                       <asp:Panel ID="Panel1" runat="server" Width="40%" >
                           ...
                           <div class="col-sm-10 col-md-10" style="padding:8px;font-weight:600">Course Code<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox></div>                 
