<%@ Page Title="" Language="C#" MasterPageFile="~/MainMP.master" AutoEventWireup="true" CodeFile="Register_fac.aspx.cs" Inherits="Register_fac" %>
     ...
     <div class="row" style="">
           <div class ="col-md-8 col-sm-8" style="padding-top:60px;padding-left:100px;padding-bottom:60px">
               <div class="panel panel-primary" style="border:1px solid;background-color:aliceblue">
                   <div class="panel-heading" style="font-size:25px; height:50px;background-color:cadetblue; font-weight:bold">Reset Password</div>
                   <div class="panel-body">
                       ...
                       <div class="col-sm-8 col-md-8" style="padding:8px;font-weight:600">DoBirth <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox2" ErrorMessage="*" ForeColor="Red" ToolTip="Mandatory field"></asp:RequiredFieldValidator>
                       ...
                       <div class="col-sm-8 col-md-8" style="padding:8px;font-weight:600">Confirm Password 
